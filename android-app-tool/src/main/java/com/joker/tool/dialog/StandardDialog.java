...
public class StandardDialog extends AlertDialog{
	...
	public static Dialog defaultBuilder(Activity act,String title,String content,boolean cancelable) {
		...
		builder.setTitle(title).setContent(content).setCancelable(cancelable).setPositiveListener(listener);
