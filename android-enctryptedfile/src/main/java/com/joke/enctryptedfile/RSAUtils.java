...
public class RSAUtils {
    ...
    public final static String KERNEL_KEY = "";
    /**
    ...
    public static boolean decryptData(InputStream in, OutputStream out, PrivateKey privateKey) {
        ...
        try {
            ...
            while ( (len = in.read(bytes)) > 0){
                out.write(cipher.doFinal(bytes,0, len));
                Log.i("MainActivity-->", "decryptData: "+new String(cipher.doFinal(bytes,0, len)));
            }
            finish = true;
        } catch (Exception e) {
            e.printStackTrace();
